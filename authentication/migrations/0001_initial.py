    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logofname', models.ImageField(blank=True, null=True, upload_to='logos/')),
                ('province_code', models.CharField(blank=True, max_length=2, null=True)),
                ('area_code', models.CharField(blank=True, max_length=4, null=True)),
                ...
                ('subscription_type', models.CharField(choices=[('F', 'Free'), ('P', 'Paid')], default='F', max_length=1)),
                ('mem_activation_status', models.CharField(choices=[('A', 'Active'), ('I', 'Inactive')], default='I', max_length=1)),
